...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(26):
            ...
            shifted_l= string.ascii_lowercase[(i+shift)%26]
            test[original]=shifted_l
        
            original=string.ascii_uppercase[i]
            shifted_u= string.ascii_uppercase[(i+shift)%26]
            test[original]=shifted_u
        return test   
    ...
    def apply_shift(self, shift):
        ...
        '''
        test = self.build_shift_dict(shift)
        encrypted_m=""
        
        for char in self.message_text:
            if char in test:
                encrypted_m+=test[char]
            else:
                encrypted_m+=char
        return encrypted_m
